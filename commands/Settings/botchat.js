            ...
            if (add_remove == "add") {
                if (client.settings.get(guild.id, "botchannel").includes(Channel.id)) {
                    return interaction.reply({
                        ...
                        embeds: [new MessageEmbed()
                            ...
                            .setTitle(`${client.emoji.x} **This Channel is already a whitelisted Bot-Channel!**`)
                        ],
                    })
                }
                ...
                return interaction.reply({
                    ...
                    embeds: [new MessageEmbed()
                        .setColor(emb.color)
                        .setFooter(client.user.username, client.user.displayAvatarURL())
                        .setTitle(`${client.emoji.check} **The Channel \`${Channel.name}\` got added to the ${client.settings.get(guild.id, "djroles").length - 1} whitelisted Bot-Channels!**`)
                ...
                if (!client.settings.get(guild.id, "botchannel").includes(Channel.id)) {
                    return interaction.reply({
                        ...
                        embeds: [new MessageEmbed()
                            .setColor(emb.errColor)
                            .setFooter(client.user.username, client.user.displayAvatarURL())
                            .setTitle(`${client.emoji.x} **This Channel is not a whitelisted Bot-Channel yet!**`)
                        ],
                    })
                }
                ...
                return interaction.reply({
                    ...
                    embeds: [new MessageEmbed()
                        .setColor(emb.color)
                        .setFooter(client.user.username, client.user.displayAvatarURL())
                        .setTitle(`${client.emoji.check} **The Channel \`${Channel.name}\` got removed from the ${client.settings.get(guild.id, "djroles").length} whitelisted Bot-Channels!**`)
                        .addField(`🎧 **Bot-Channel${client.settings.get(guild.id, "botchannel").length > 1 ? "s" : ""}:**`, `>>> ${djs}`, true)
                    ],
                })
            }
