                    ...
                    .then((m) => {
                        ...
                        collector.on("collect", async (button) => {
                            ...
                            if (button.customId == "declinettt") {
                                ...
                                let fighters = [interaction.member.id, opponent.id].sort(() =>
                                    Math.random() > 0.5 ? 1 : -1
                                );
                                ...
                                const xoemb = new MessageEmbed()
                                    ...
                                    .setFooter(client.user.username, client.user.displayAvatarURL({ dynamic: true }))
                                    .setTimestamp();
                                let infomsg = await interaction.channel
                                    .send({ embeds: [xoemb] })
                                    .then((ms) => {
                                ...
                                async function tictactoe(m) {
                                    ...
                                    m.edit({
                                        content: `Waiting for Input | <@!${Args.userid
                                            }> | Your Emoji: ${Args.user == 0 ? `${o_emoji}` : `${x_emoji}`
                                            }`,
                                        components: [a, b, c]
                                    });
